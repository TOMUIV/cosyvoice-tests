...
tests=[
    ("t01_pupu_fail",       "于是扑扑衣上的泥土",      WARM),
    ("t02_pupu_add_ta",     "于是他扑扑衣上的泥土",     WARM),
    ("t03_pupu_only",       "于是扑扑",                 WARM),
    ("t04_pupu_add_ta_only","于是他扑扑",               WARM),
    ("t05_pupu_full",       "于是扑扑衣上的泥土，心里很轻松似的", WARM),
    ("t06_paipai_fail",     "于是拍了拍衣上的泥土",     WARM),
    ("t07_pu_change",       "于是扑了扑衣上的泥土",     WARM),
    ("t08_dou_dou",         "于是抖了抖衣上的泥土",     WARM),
]
